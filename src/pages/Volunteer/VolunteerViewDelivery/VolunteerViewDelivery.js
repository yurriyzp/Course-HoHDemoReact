...
class VolunteerViewDelivery  extends Component {
    constructor(props){
        super(props);
        this.state={
          redirect:""
          ...
          <div class="justify-content-center row">
            ...
            <div class="justify-content-center row">
                <div class="card" style={{backgroundColor: "dodgerblue"}}>
                    <div class="card-body">
                      <h5 class="card-title">Request status:{this.props.requests.request.status}</h5>
                      <h6 class="card-subtitle mb-2 ">Type:delivery</h6>
                      <p class="card-text">
